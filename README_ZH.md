...
### Claude Code、Claude Desktop、Codex、Gemini CLI、OpenCode、OpenClaw、Hermes Agent、DeepSeek Harness（dsh）和 ZCode 的全方位管理工具
...
现代 AI 编程依赖于 Claude Code、Claude Desktop、Codex、Gemini CLI、OpenCode、OpenClaw、Hermes、DeepSeek Harness（dsh）和 ZCode 等工具——但每个工具都有自己的配置格式。切换 API 供应商意味着手动编辑 JSON、TOML 或 `.env` 文件，而在多个工具之间缺乏一个统一管理 MCP, SKILLS 的方式。
...
- **一个应用，九个工具** — 在单一界面中管理 Claude Code、Claude Desktop、Codex、Gemini CLI、OpenCode、OpenClaw、Hermes、DeepSeek Harness（dsh）和 ZCode
- **告别手动编辑** — 50+ 供应商预设，包括 AWS Bedrock、NVIDIA NIM 和社区中转服务；一键即可切换
- **统一 MCP, SKILLS 管理** — 一个面板管理 Claude、Codex、Gemini、OpenCode、Hermes、dsh 和 ZCode 的 MCP, SKILLS, 支持双向同步
...
- **9 个支持工具，50+ 预设** — Claude Code、Claude Desktop、Codex、Gemini CLI、OpenCode、OpenClaw、Hermes、dsh（DeepSeek Harness）、ZCode；复制 key 即可一键导入
...
- **统一 MCP 面板** — 管理 Claude、Codex、Gemini、OpenCode、Hermes、dsh 和 ZCode 的 MCP 服务器，双向同步，支持 Deep Link 导入
...
CC Switch 支持九个工具：**Claude Code**、**Claude Desktop**、**Codex**、**Gemini CLI**、**OpenCode**、**OpenClaw**、**Hermes**、**dsh（DeepSeek Harness）** 和 **ZCode**。每个工具都有专属的供应商预设和配置管理。
