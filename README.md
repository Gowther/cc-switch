...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Gemini CLI, OpenCode, OpenClaw, Hermes Agent, DeepSeek Harness & ZCode
...
Modern AI-powered coding relies on tools like Claude Code, Claude Desktop, Codex, Gemini CLI, OpenCode, OpenClaw, Hermes, DeepSeek Harness (dsh), and ZCode — but each has its own configuration format. Switching API providers means manually editing JSON, TOML, or `.env` files, and there is no unified way to manage MCP and Skills across multiple tools.
...
- **One App, Nine Tools** — Manage Claude Code, Claude Desktop, Codex, Gemini CLI, OpenCode, OpenClaw, Hermes, DeepSeek Harness (dsh), and ZCode from a single interface
- **No More Manual Editing** — 50+ provider presets including AWS Bedrock, NVIDIA NIM, and community relays; just pick and switch
- **Unified MCP & Skills Management** — One panel to manage MCP servers and Skills across Claude, Codex, Gemini, OpenCode, Hermes, dsh, and ZCode with bidirectional sync
...
- **9 supported tools, 50+ presets** — Claude Code, Claude Desktop, Codex, Gemini CLI, OpenCode, OpenClaw, Hermes, dsh (DeepSeek Harness), ZCode; copy your key and import with one click
...
- **Unified MCP panel** — Manage MCP servers across Claude, Codex, Gemini, OpenCode, Hermes, dsh, and ZCode with bidirectional sync and Deep Link import
...
CC Switch supports nine tools: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, **Hermes**, **dsh (DeepSeek Harness)**, and **ZCode**. Each tool has dedicated provider presets and configuration management.
