...
const PromptFormPanel: React.FC<PromptFormPanelProps> = ({
  ...
  // dsh/zcode 不支持文件级 Prompts，从映射中排除（对齐 openclaw 在 Modal 中的排除方式）
  const filenameMap: Record<Exclude<AppId, "dsh" | "zcode">, string> = {
    claude: "CLAUDE.md",
  ...
  const filename = filenameMap[appId as Exclude<AppId, "dsh" | "zcode">];
